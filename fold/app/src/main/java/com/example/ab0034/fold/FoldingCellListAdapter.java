package com.example.ab0034.fold;
...
public class FoldingCellListAdapter extends ArrayAdapter<Item> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (cell == null) {
            ...
            viewHolder.price = (TextView) cell.findViewById(R.id.txtTicketNumber);
...
//            viewHolder.date = (TextView) cell.findViewById(R.id.title_date_label);
            viewHolder.fromAddress = (TextView) cell.findViewById(R.id.txtCustomerAddress);
            viewHolder.toAddress = (TextView) cell.findViewById(R.id.txtStatus);
