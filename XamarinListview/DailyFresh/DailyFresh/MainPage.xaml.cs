            ...
            if (CrossConnectivity.Current.IsConnected)
            {
                try
                {
                  ...
                  //  activity_indicator.IsRunning = true;
                    ...
                    var tr = JsonConvert.DeserializeObject<List<Model>>(content);
                    //After deserializing , we store our data in the List called ObservableCollection
                    ObservableCollection<Model> trends = new ObservableCollection<Model>(tr);
                    ...
                    heightList = trends.Count.ToString();
                    PendingCount.Text = heightList;
